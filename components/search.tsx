            ...
            >
                ...
                <DialogContent className="p-0 max-w-[700px] sm:top-[38%] top-[45%] !rounded-md">
                    ...
                    <div className="max-h-[350px] overflow-y-auto scrollbar-thin ">
                        <div className="flex flex-col items-start overflow-y-auto sm:px-2 px-1 pb-4 scrollbar-thin ">
                            {filteredResults.map((item) => {
                                const level = (item.href.split("/").slice(1)
                                    .length - 1) as keyof typeof paddingMap;
